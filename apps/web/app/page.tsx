    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20 pt-16 text-center">
        ...
        <p className="mx-auto mb-10 max-w-lg text-base text-zinc-400">
          Auto-sync your Claude Code and Cursor token usage. See how you stack
          up against your crew. Flex the burn.
        </p>
      ...
      <section className="border-y border-zinc-800 bg-zinc-900/50 py-20">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="mb-12 text-center text-3xl font-black tracking-tight">
            How it works
          </h2>
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="mt-3 text-center text-sm text-zinc-600">
          (Sample data — yours will be real)
        </p>
      </section>
      ...
      <section className="border-t border-zinc-800 bg-zinc-900/30 py-12">
        <div className="mx-auto max-w-2xl px-6 text-center">
          <p className="text-2xl font-black">
            We literally can&apos;t read your prompts.
          </p>
          <p className="mt-3 text-zinc-400">
            Token Rats counts only — we parse token numbers from your local
            logs, never the content. The CLI is open source so you can verify
