...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: "Join a Token Rats room and start tracking your token burn with friends.",
  };
}
...
export default async function JoinPage({ params }: Props) {
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900">
            <div className="p-8 text-center">
              ...
              <p className="mb-6 font-mono text-2xl font-black tracking-widest text-rat-400">
                {code}
              </p>
  ...
  // Signed in — auto-join and redirect
  return <JoinClient code={code} cookieHeader={cookieHeader} />;
}
